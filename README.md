...
After setting up your app via the CLI, you'll find a demo page has been added to your app. This is intended as an in-app API reference, though in a proper store it might a little different. 
