...
import { useStripeCustomerFetch } from "../../hooks/useStripeCustomerFetch.js";

import { createStripeApi } from "../createStripeApi.js";
import { StripeContext } from "../StripeContext.js";
import { useOnceDefined } from "./useOnceDefined.js";
import type { Cart, Customer, CustomerDescription } from "../types.js";
...
export const StripeProvider = ({
  ...
  const [stripeCustomer, setCustomer] = useState<Customer | null>(null);
